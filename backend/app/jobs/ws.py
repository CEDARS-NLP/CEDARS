"""WebSocket endpoint for real-time background job progress."""
...
async def job_progress_ws(websocket: WebSocket, project_id: str, job_id: str):
    """Stream background job progress over WebSocket.
